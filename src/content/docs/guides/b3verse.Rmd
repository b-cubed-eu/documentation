...
We simulate three species for 5 time points where each species has a different average total number of occurrences at time point one (see also [this tutoria](https://b-cubed-eu.github.io/gcube/articles/multi-species-approach.html)).
...
occurrence_cube_df <- occurrence_cube_full %>%
  select("cell_code", "time_point", "species", "n", "min_coord_uncertainty")
