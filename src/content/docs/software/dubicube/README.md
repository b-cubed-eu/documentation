...
<img src="https://b-cubed-eu.github.io/dubicube/reference/figures/dubicube-flow.png" alt="dubicube indicator calculation workflow." width="80%">
...
- `filter_cube()`  
  ...
  📘 [Read the tutorial
  →](https://docs.b-cubed.eu/software/dubicube/diagnostics-and-filtering/)
