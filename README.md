...
2. Check if vignette is listed in [`vignettes.yml`](src/externalvignettes.yml) (organized by R package). If not, add it (use the other vignettes as examples).
3. Open `documentation.Rproj` in R Studio and open [`rmd_to_md.Rmd`](src/externalrmd_to_md.Rmd).
